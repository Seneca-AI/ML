...
if __name__ == '__main__':
    ...
    test
    """
    train_epoch_nums = lanenet_cfg.TRAIN.EPOCH_NUMS
    batch_size = lanenet_cfg.TRAIN.BATCH_SIZE
    model_save_dir = lanenet_cfg.TRAIN.MODEL_SAVE_DIR
    snapshot_epoch = lanenet_cfg.TRAIN.SNAPSHOT_EPOCH
    enable_miou = lanenet_cfg .TRAIN.COMPUTE_MIOU.ENABLE
    with open('./test_config_file.json', 'w', encoding='utf-8') as file:
        lanenet_cfg.dump_to_json_file(file)
