...
def renaming_by_adding_number_names(Source2,Dest2):
    ...
    hi = sorted(names)
    return hi
#%% generalized renaming after fetching the images
# Source = "/media/sagar/New Volume/everything/job/Seneca/data/train_set/clips/0531/*/*"
# Dest = "/media/sagar/New Volume/everything/job/Seneca/detecting_lane_changes/images/delete_if_seen/"
Source = "/media/sagar/New Volume/everything/job/Seneca/data/train_set/clips/0601/*/*"
Dest = "/media/sagar/New Volume/everything/job/Seneca/data/making_vid/frames4/"

def generalized_renaming_after_fetching_the_images(Source,Dest):
    """
